<x-app-layout>
    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <div class="flex-1 px-8">
            <!-- Top Bar -->
            <div class="flex justify-between bg-blue-50 p-6 rounded-lg shadow-lg items-center mb-8">
            ...
            <div class="grid grid-cols-3 gap-8">
                <!-- Calendar and Stats -->
                <div class="col-span-1 bg-white p-6 bg-blue-50 p-6 rounded-lg shadow-lg shadow">
                ...
                <!-- Usage Chart -->
                <div class="col-span-2 bg-blue-50 p-6 rounded-lg shadow-lg">
